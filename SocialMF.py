...
class SocialMF():
    ...
    def loss(self, users=None, items=None, socials = None):
        ...
        sq_error += self.lambda_c * (np.sum(social_error * social_error))
...
if __name__ == "__main__":
    ...
    pmf = SocialMF(ratings, socials, latent_d=latent_d_value, lambda_c = lambda_c_value, lambda_u = lambda_u_value, lambda_v = lambda_v_value, Wm = Wm_value)
    iterations = 5000
    liks = []
